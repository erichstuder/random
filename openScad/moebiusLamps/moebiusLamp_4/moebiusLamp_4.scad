...
function faces_border() = [
	for( n = [0:4:4*(nrOfPoints-2)] ) [1, 0, 4, 5] + [n, n, n, n],
	[4*nrOfPoints-2, 4*nrOfPoints-1, 0, 1],
...
function faces_plane() = [
	//outter surface 1
	for( n = [0:4:4*(nrOfPoints-2)] ) [4, 0, 4*nrOfPoints+0, 4*nrOfPoints+4] + [n, n, n, n],
	[4*nrOfPoints-4, 8*nrOfPoints-4, 4*nrOfPoints+3, 3],
	for( n = [0:4:4*(nrOfPoints-2)] ) [7, 3, 4*nrOfPoints+3, 4*nrOfPoints+7] + [n, n, n, n],
	[4*nrOfPoints-1, 8*nrOfPoints-1, 4*nrOfPoints+0, 0],

	//outter surface 2
	for( n = [0:4:4*(nrOfPoints-2)] ) [2, 6, 4*nrOfPoints+6, 4*nrOfPoints+2] + [n, n, n, n],
	[8*nrOfPoints-2, 4*nrOfPoints-2, 1, 4*nrOfPoints+1],
	for( n = [0:4:4*(nrOfPoints-2)] ) [1, 5, 4*nrOfPoints+5, 4*nrOfPoints+1] + [n, n, n, n],
	[8*nrOfPoints-3, 4*nrOfPoints-3, 2, 4*nrOfPoints+2],


	//step 1
	for( n = [0:4:4*(nrOfPoints-2)] ) [4+4*nrOfPoints, 0+4*nrOfPoints, 0+8*nrOfPoints, 4+8*nrOfPoints] + [n, n, n, n],
	[8*nrOfPoints-4, 12*nrOfPoints-4, 8*nrOfPoints+3, 4*nrOfPoints+3],
	for( n = [0:4:4*(nrOfPoints-2)] ) [7+4*nrOfPoints, 3+4*nrOfPoints, 3+8*nrOfPoints, 7+8*nrOfPoints] + [n, n, n, n],
	...
	[12*nrOfPoints-3, 8*nrOfPoints-3, 4*nrOfPoints+2, 8*nrOfPoints+2],
	for( n = [0:4:4*(nrOfPoints-2)] ) [1+4*nrOfPoints, 5+4*nrOfPoints, 5+8*nrOfPoints, 1+8*nrOfPoints] + [n, n, n, n],
	[12*nrOfPoints-2, 8*nrOfPoints-2, 4*nrOfPoints+1, 8*nrOfPoints+1],


	//path
	for( n = [0:4:4*(nrOfPoints-2)] ) [0+8*nrOfPoints, 2+8*nrOfPoints, 6+8*nrOfPoints, 4+8*nrOfPoints] + [n, n, n, n],
	[12*nrOfPoints-4, 12*nrOfPoints-2, 8*nrOfPoints+1,  8*nrOfPoints+3],
	for( n = [0:4:4*(nrOfPoints-2)] ) [3+8*nrOfPoints, 1+8*nrOfPoints, 5+8*nrOfPoints, 7+8*nrOfPoints] + [n, n, n, n],
