 ...
 */
function ExText1(guiAction) {
    DrawExamples.call(this, guiAction);
}

ExText1.prototype = new DrawExamples();

ExText1.prototype.beginEvent = function() {
...
ExText1.init = function(basePath) {
    var action = new RGuiAction(qsTr("Text"), RMainWindowQt.getMainWindow());
    action.setRequiresDocument(true);
    action.setScriptFile(basePath + "/ExText1.js");
